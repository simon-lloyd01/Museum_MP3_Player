...
I wanted the finished units to look neat, so there are also a couple of very simple 3D printable cases based on modified files from thingiverse.com. These use Uno boards and not the smaller Nano, as it turned out neater to fit a proto board on top of the Uno and mount the MP3 module in the same footprint as the Uno.
